...
export function Dashboard() {
  ...
  const isSyntheticData = stats.isFallback === true;
      ...
      {isSyntheticData && (
        <div className="flex items-center gap-3 bg-amber-500/15 border border-amber-500/30 rounded-lg p-4">
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-amber-200">Trading on Simulated Data</p>
            <p className="text-xs text-amber-300/80">Broker connection failed. Real orders will NOT execute. This feed is for testing only.</p>
          </div>
        </div>
      )}
